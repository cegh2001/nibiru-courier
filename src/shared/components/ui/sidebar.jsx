...
const Sidebar = React.forwardRef((
  ...
  return (
    <div
      ...
      data-side={side}>
      {/* Offcanvas: no gap (pure overlay). Other modes: gap pushes content */}
      <div
        className={cn(
        ...
        style={collapsible !== "offcanvas" ? { width: "var(--sidebar-width)" } : undefined}
      />
      {/* Backdrop overlay for offcanvas mode */}
      {collapsible === "offcanvas" && (
        <div
          className={cn(
            "fixed inset-0 z-40 bg-white/10 backdrop-blur-[2px] transition-opacity duration-300",
